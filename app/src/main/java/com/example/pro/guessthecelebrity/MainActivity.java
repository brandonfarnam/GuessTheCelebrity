package com.example.pro.guessthecelebrity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void celebChosen(View view) {
        if (view.getTag().toString().equals(Integer.toString(loationOfCorrectAnswer))) {
    ...
    public void createNewQuestion() {
        ...
        try {
            ...
            loationOfCorrectAnswer = random.nextInt(4);
            int incorrectAnswerLocation;
            for (int i = 0 ; i < 4; i++) {
                if (i == loationOfCorrectAnswer) {
